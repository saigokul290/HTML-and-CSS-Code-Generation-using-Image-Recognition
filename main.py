...
sys.path.append("Automatic-HTML-Code-Generation")
...
PATH_TO_FROZEN_GRAPH = 'frozen_inference_graph_816.pb'
...
def processImage(image): 
    ...
    cv2.imwrite('static/output.jpg', resized)
##    cv2.imshow('output_image',resized)
##    cv2.waitKey(0)
##    cv2.destroyAllWindows()
    #delete the temporary processes file if exists
##    path='C:\\Users\\LENOVO\\Desktop\\Automatic-HTML-Code-Generation\\TEMP_IMAGE'
##    os.remove('temp.jpg')
    #run the generated html code in browser as a webpage
    #give the complete path to the generated html file
##    file_path = 'C:\\Users\\LENOVO\\Desktop\\Automatic-HTML-Code-Generation\\generated_code.html'
##    new = 2
...
##path='C:\\Users\\LENOVO\\Desktop\\Automatic-HTML-Code-Generation\\new_test_imgs\\test_imgs_2.jpg'
####C:\Users\LENOVO\Desktop\Automatic-HTML-Code-Generation\new_test_imgs
